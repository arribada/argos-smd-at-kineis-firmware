 ...
 * @brief   Low-battery (LB) mode hysteresis — the ONLY battery-driven behavior
 *          after the hard TX veto was removed (audit #9). Mirrors lb_update()
...
int main(void)
{
	TEST_SUITE_START("LB mode hysteresis (sole battery reaction after veto removal)");
